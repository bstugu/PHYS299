These are n-tuples containing simulations of some Higgs bosons produced in gluon-gluon fusion in selected decay channels. (e+e-,Z(->e+e-)gammma,mu+mu-,(Z->mu+mu1)gamma) and reconstructed with Delphes.
